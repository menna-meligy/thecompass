...
import { Plus, X, GripVertical, ChevronDown, ChevronUp, Trophy, Lock } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-6 flex-wrap">
        <h2 className="text-white font-black text-xl" style={{ color: "white" }}>
          {trackLabel || (isAr ? "لوحة الأهداف" : "Goals Board")}
        </h2>
        {total > 0 && (
        ...
        {readOnly ? (
          <div
            ...
            style={{ marginInlineStart: "auto", padding: "3px 10px", borderRadius: "8px", background: "rgba(148,163,184,0.08)", border: "1px solid rgba(148,163,184,0.15)" }}
          >
            ...
            >
              ...
              <div style={{ padding: "12px", flex: 1, display: "flex", flexDirection: "column", gap: "8px" }}>
                {colTasks.map((task) => (
                  <div
                    key={task.id}
                    draggable={!task.pinned && !readOnly}
                    onDragStart={() => !task.pinned && !readOnly && onDragStart(task.id)}
                    style={{
                      ...
                      borderRadius: "8px",
                      padding: "11px 13px",
                      cursor: task.pinned || readOnly ? "default" : "grab",
                      display: "flex",
                      alignItems: "center",
                      gap: "10px",
                  ...
                  >
                    {!task.pinned && !readOnly && <GripVertical className="h-3.5 w-3.5 flex-shrink-0" style={{ color:"rgba(255,255,255,0.15)" }} />}
